...
const htcProjLayer = new FeatureLayer({
    url: "https://services5.arcgis.com/CmuSiXApoWtqLYty/arcgis/rest/services/HTC_Projects_All_2002_2019/FeatureServer",
    outFields: ["*"],
    minScale: 144448.0,
    //visible: true,
    title: "htcProjects",
...
const htc = new FeatureLayer({
    url: "https://services5.arcgis.com/CmuSiXApoWtqLYty/arcgis/rest/services/City_HTCs_Grouped_EconData/FeatureServer",
    outFields: ["*"],
...
const congDist = new FeatureLayer({
    url: "https://services5.arcgis.com/CmuSiXApoWtqLYty/arcgis/rest/services/CongDist_w_HTC_Counts_Clipped_EconData/FeatureServer",
    outFields: ["*"],
...
/////////////////////////////////////////////////////////////////
 ...
 const stateBounds = new FeatureLayer({
    url: "https://services5.arcgis.com/CmuSiXApoWtqLYty/arcgis/rest/services/States_w_HTC_Counts_Clipped_EconData/FeatureServer",
    outFields: ["*"],
    visible: false,
    maxScale: 144448.1, 
...
////////////////////Add Background Layers////////////////////
    ...
    const cdStateBounds = new FeatureLayer({
        url: "https://services5.arcgis.com/CmuSiXApoWtqLYty/arcgis/rest/services/US_States_Boundaries/FeatureServer",
        popupEnabled: false,
    ...
    const usbounds = new FeatureLayer({
        url: "https://services5.arcgis.com/CmuSiXApoWtqLYty/arcgis/rest/services/US_Boundary/FeatureServer",
        popupEnabled: false,
        maxScale: 1155581, 
        renderer: {
            type: "simple",
